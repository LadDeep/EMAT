...
if __name__ == '__main__':
    ...
    json_data = {"group_name": "testing 5",
                 "group_currency": "USD", "participants": ["curl@gmail.com"]}
    json_data_1 = {"group_name": "testing 6",
                   "group_currency": "USD", "participants": ["curl@gmail.com"]}
    res = requests.post("http://127.0.0.1:5004/group/register",
                        headers=headers, json=json_data)
    res2 = requests.post("http://127.0.0.1:5004/group/register",
                         headers=headers, json=json_data_1)
