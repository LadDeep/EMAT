...
# def test_create_group(test_client, token):
#     data = {"group_name": "test", "group_currency": "CAD"}
#     response = test_client.post("/group/register", headers={
#                            'Authorization': f'Bearer {token}', 'Content-Type': 'application/json'}, json=data)
#     assert response.status_code == 201
#     assert response.content_type == 'application/json'


# def test_create_expense_valid_request(test_client, token):
#     # Test valid request
#     data = {"group_id": 1, "amount": 100, "date": "2023-04-09T00:00:00.000Z"}
...
# def test_create_expense_missing_group_id(test_client, token):
...
# def test_detail_expense_valid_request(test_client, token):
#     # Test valid request
